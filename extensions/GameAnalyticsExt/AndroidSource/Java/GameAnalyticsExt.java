...
public class GameAnalyticsExt
{
    ...
    public String getCommandCenterValueAsString(String key)
    {
        return GameAnalytics.getCommandCenterValueAsString(key);
    }

    public String getCommandCenterValueAsStringWithDefaultValue(String key, String defaultValue)
    {
        return GameAnalytics.getCommandCenterValueAsString(key, defaultValue);
    }

    public double isCommandCenterReady()
    {
        return GameAnalytics.isCommandCenterReady() ? 1 : 0;
    }

    public String getConfigurationsContentAsString()
    {
